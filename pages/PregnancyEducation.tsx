...
import { ShieldCheck, Clock, Brain, Baby, Shield, Heart, Calendar, BookOpen, Lightbulb, X, Check, ChevronLeft, ChevronRight, Volume2, Share2, Globe } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <div className="flex flex-col items-center justify-center text-center py-16 bg-slate-50/50 rounded-[2rem] my-4">
        ...
        <SpeakableText text="Your body is creating a miracle. Trust the journey and embrace each moment.">
      ...
      <div className="bg-white rounded-[2rem] p-8 lg:p-12 shadow-sm border border-slate-100 overflow-hidden relative">
         ...
         <div className="relative z-10">
            ...
            <SpeakableText text="Your pregnancy knowledge hub. Expert-curated content to guide you through each trimester. From fetal development to labor preparation, find trusted information here.">
